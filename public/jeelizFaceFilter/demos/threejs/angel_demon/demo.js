...
function init_threeScene(spec) {
  ...
  */
  ...
  loaderAngelIntro.load('./models/angel/angel_intro.json', function (geometry) {
  ...
  loaderAngelIdle.load('./models/angel/angel_idle.json', function (geometry) {
    const mat = new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load('./models/angel/diffuse_angel.png'),
      morphTargets: true
    });
  ...
  loaderAngelFight.load('./models/angel/angel_fight.json', function (geometry) {
    const mat = new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load('./models/angel/diffuse_angel.png'),
      morphTargets: true
    });
  ...
  */
  ...
  loaderHarpIntro.load('./models/angel/harp_intro.json', function (geometry) {
    const mat = new THREE.MeshBasicMaterial({
  ...
  loaderHarpIdle.load('./models/angel/harp_idle.json', function (geometry) {
    const mat = new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load('./models/angel/harpe.jpg'),
      morphTargets: true
    });
  ...
  loaderHarpFight.load('./models/angel/harp_fight.json', function (geometry) {
    const mat = new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load('./models/angel/harpe.jpg'),
      morphTargets: true
    });
  ...
  */
  ...
  loaderDemonIntro.load('./models/demon/demon_intro.json', function (geometry) {
    const mat = new THREE.MeshBasicMaterial({
  ...
  loaderDemonIdle.load('./models/demon/demon_idle.json', function (geometry) {
    const mat = new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load('./models/demon/diffuse_demon.png'),
      morphTargets: true
    });
  ...
  loaderDemonFight.load('./models/demon/demon_fight.json', function (geometry) {
    const mat = new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load('./models/demon/diffuse_demon.png'),
      morphTargets: true
    });
  ...
  */
  ...
  loaderForkIntro.load('./models/demon/fourche_intro.json', function (geometry) {
    const mat = new THREE.MeshBasicMaterial({
  ...
  loaderForkIdle.load('./models/demon/fourche_idle.json', function (geometry) {
    const mat = new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load('./models/demon/fourche.jpg'),
      morphTargets: true
    });
  ...
  loaderForkFight.load('./models/demon/fourche_fight.json', function (geometry) {
    const mat = new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load('./models/demon/fourche.jpg'),
      morphTargets: true
    });
