...
var fx = (function () {
  ...
  function Q(b, d, c) {
    ...
    a.lensBlur0 =
      a.lensBlur0 || new h(null, e + 'void main(){gl_FragColor=sample(delta0);}');
    a.lensBlur1 =
      a.lensBlur1 ||
      new h(null, e + 'void main(){gl_FragColor=(sample(delta0)+sample(delta1))*0.5;}');
    a.lensBlur2 =
      a.lensBlur2 ||
      new h(
        null,
          ...
          if (null !== c) {
            ...
            if ('[object Array]' == Object.prototype.toString.call(d))
              switch (d.length) {
                ...
                default:
                  throw (
                    'dont\'t know how to load uniform "' + e + '" of length ' + d.length
                  );
              }
