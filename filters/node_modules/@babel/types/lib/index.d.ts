...
export type Pureish = FunctionDeclaration | FunctionExpression | StringLiteral | NumericLiteral | NullLiteral | BooleanLiteral | RegExpLiteral | ArrowFunctionExpression | BigIntLiteral;
...
export type TSBaseType = TSAnyKeyword | TSBooleanKeyword | TSBigIntKeyword | TSNeverKeyword | TSNullKeyword | TSNumberKeyword | TSObjectKeyword | TSStringKeyword | TSSymbolKeyword | TSUndefinedKeyword | TSUnknownKeyword | TSVoidKeyword | TSThisType | TSLiteralType;
...
export function file(program: Program, comments?: Array<Comment> | null, tokens?: Array<any> | null): File;
...
export function objectMethod(kind: "method" | "get" | "set" | undefined, key: Expression | Identifier | StringLiteral | NumericLiteral, params: Array<Identifier | Pattern | RestElement | TSParameterProperty>, body: BlockStatement, computed?: boolean, generator?: boolean, async?: boolean): ObjectMethod;
...
export function importAttribute(key: Identifier, value: StringLiteral): ImportAttribute;
...
export function recordExpression(properties: Array<ObjectProperty | ObjectMethod | SpreadElement>): RecordExpression;
export function tupleExpression(elements?: Array<null | Expression | SpreadElement>): TupleExpression;
...
export function tsLiteralType(literal: NumericLiteral | StringLiteral | BooleanLiteral | BigIntLiteral): TSLiteralType;
